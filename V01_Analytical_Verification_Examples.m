% Generation of Verification examples based on the analytical formulation
...
% ---- Verification ----
Verification.Save.on = 1;
Verification.Save.folder = 'Verification\';
%Verification.Save.name = 'Verification_Analytical_SprungVeh'; Opt.ramp_on = 0; Opt.damp_on = 0; Opt.acc_on = 0;
%Verification.Save.name = 'Verification_Analytical_RampOn'; Opt.ramp_on = 1; Opt.damp_on = 0; Opt.acc_on = 0;
%Verification.Save.name = 'Verification_Analytical_DampOn'; Opt.ramp_on = 1; Opt.damp_on = 1; Opt.acc_on = 0;
%Verification.Save.name = 'Verification_Analytical_AccOn'; Opt.ramp_on = 1; Opt.damp_on = 1; Opt.acc_on = 1;
...
% ---- Saving ----
if myIsfield(Verification,{'Save',1,'on'},1)
    % Data to save
    Data.Time.values = t_array;
    Data.MidSpan.Disp.values = y_beam_05;
    % Saving
    save([Verification.Save.folder,Verification.Save.name],'Data');
    % Report
    disp('Results have been saved in:');
    disp([Verification.Save.folder,Verification.Save.name]);
