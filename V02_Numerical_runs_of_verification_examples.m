% Simulation of the verification examples using VBI-2D
...
%Verification.Save.name = 'Verification_Numerical_SprungVeh'; Opt.ramp_on = 0; Opt.damp_on = 0; Opt.acc_on = 0;
%Verification.Save.name = 'Verification_Numerical_RampOn'; Opt.ramp_on = 1; Opt.damp_on = 0; Opt.acc_on = 0;
%Verification.Save.name = 'Verification_Numerical_DampOn'; Opt.ramp_on = 1; Opt.damp_on = 1; Opt.acc_on = 0;
%Verification.Save.name = 'Verification_Numerical_AccOn'; Opt.ramp_on = 1; Opt.damp_on = 1; Opt.acc_on = 1;
