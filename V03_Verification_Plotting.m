% Plotting of verification results for VBI-2D
...
Load.Num.subfolder = 'Verification\';
Load.Num.files2load = {...
...
Load.Analytic.subfolder = 'Verification\';
Load.Analytic.files2load = {...
    'Verification_Analytical_SprungVeh',...
    'Verification_Analytical_DampOn',...
    'Verification_Analytical_RampOn',...
    'Verification_Analytical_AccOn',...
    };
